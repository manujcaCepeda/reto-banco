...
SELECT 'RETIRO', 575, (2000 - 575), id FROM bank.cuenta WHERE numero_cuenta = '478758';

-- Depósito de 600 en cuenta 225487
INSERT INTO bank.movimiento (tipo_movimiento, valor, saldo, cuenta_id)
SELECT 'DEPOSITO', 600, (100 + 600), id FROM bank.cuenta WHERE numero_cuenta = '225487';

-- Depósito de 150 en cuenta 495878
INSERT INTO bank.movimiento (tipo_movimiento, valor, saldo, cuenta_id)
SELECT 'DEPOSITO', 150, (0 + 150), id FROM bank.cuenta WHERE numero_cuenta = '495878';

-- Retiro de 540 en cuenta 496825
INSERT INTO bank.movimiento (tipo_movimiento, valor, saldo, cuenta_id)
SELECT 'RETIRO', 540, (540 - 540), id FROM bank.cuenta WHERE numero_cuenta = '496825';
